  ...
  return (
    <section className='py-10'>
        <div className='flex flex-col justify-center px-10 py-4 sm:px-4 w-4/5 mx-auto h-full sm:w-full border-t'>
            <div className='flex gap-10 mt-5 sm:flex-col'>
                ...
                <div className='flex w-3/4 sm:w-full sm:gap-5 justify-between sm:flex-wrap'>
                    <div>
                        <h1 className='mb-3 font-bold'>For Designers</h1>
                        <li>About us</li>
