...
export default function Offer() {
  return (
    <section className='bg-[#E1D5F5] dark:bg-dark h-[400px] sm:h-full'>
        <div className='flex sm:flex-col sm:py-10 justify-center py-5 items-center px-10 sm:px-4 w-4/5 mx-auto h-full sm:w-full'>
